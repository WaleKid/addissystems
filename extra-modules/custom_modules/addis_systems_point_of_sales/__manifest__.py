{
    ...
    "depends": [
        ...
        "addis_systems_theme",
        "point_of_sale",
        "addis_systems_invoice_exchange",
    ],
    ...
    "assets": {
        "point_of_sale.assets": [
            ...
            (
                ...
                "addis_systems_point_of_sales/static/src/scss/point_of_sales.scss",
            ),
            (
                "after",
                "point_of_sale/static/src/scss/pos_variables_extra.scss",
                "addis_systems_point_of_sales/static/src/scss/point_of_sales_variables.scss",
            ),
        ],
