...
odoo.define('addis_systems_point_of_sales.models', function (require) {
    "use strict";
       ...
       async _processData(loadedData) {
        ...
        _save_to_server (orders, options) {
            ...
            var args = [_.map(orders, function (order) {
                    order.to_invoice = options.to_invoice || true;
                    return order;
                })];
    ...
    class Order extends PosModel {
        ...
        export_as_JSON() {
            ...
            var json = {
                ...
                to_invoice: this.to_invoice ? this.to_invoice : true,
