                        ...
                        env["mail.activity"].create(
                            {
                                "display_name": "Addis Systems Vendor Bill",
                                "summary": _(
                                    "New Refund Bill to Confirm from %s",
                                    credit_note.partner_id.name,
                                ),
                                "date_deadline": dead_line,
                                "user_id": user.id,
